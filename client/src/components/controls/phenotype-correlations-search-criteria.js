                ...
                <Tab
                    ...
                    <div className="row left py-1">
                        ...
                        <div className="col-md-auto ml-1 px-0">
                            { collapseCriteria && (
                                <>  
                                    ...
                                    <span className="ml-1">
                                        {
                                            searchCriteriaPhenotypeCorrelations && searchCriteriaPhenotypeCorrelations.phenotypes && searchCriteriaPhenotypeCorrelations.phenotypes.length > 1 ? (<span>and</span>) : (<></>)
                                        }
                                        <button 
                                            ...
                                            aria-expanded={!collapseCriteria}>
                                            {
                                                searchCriteriaPhenotypeCorrelations && searchCriteriaPhenotypeCorrelations.phenotypes ? searchCriteriaPhenotypeCorrelations.phenotypes.length - 1 + ` other${searchCriteriaPhenotypeCorrelations.phenotypes.length - 1 === 1 ? '' : 's'}` : ''
                                            }
                                        </button>
                                    </span>
                                </>
                        ...
                        <div className="col-md-auto ml-1 px-0">
                            ...
                            {searchCriteriaPhenotypeCorrelations && searchCriteriaPhenotypeCorrelations.gender ? displayGender(searchCriteriaPhenotypeCorrelations.gender) : 'None'}
                        </div>
                    </div>

                    <div className="right py-1">
                        <span>Total Phenotypes: </span>
                        {searchCriteriaPhenotypeCorrelations && searchCriteriaPhenotypeCorrelations.totalPhenotypes ? searchCriteriaPhenotypeCorrelations.totalPhenotypes : 'None'}
                    </div>
