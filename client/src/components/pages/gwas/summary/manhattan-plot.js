            ...
            return h('div', { className: '' }, [
              ...
              h('div', null, [
                ...
                h(
                  ...
                  {
                    className: 'font-weight-bold',
                    href: `${ldLinkUrl}?var=${record.snp}&pop=${ancestry}&genome_build=grch37&r2_d=r2&window=500000&collapseTranscript=true&annotate=forge`,
                    target: '_blank'
                  },
                  'Find variants in LD'
                )
                ...
                h(
                  ...
                  {
                    className: 'font-weight-bold',
                    href:  `${ldLinkUrl}?snps=${record.snp}&pop=${ancestry}&tissues=all&genome_build=grch37&r2_d=r2&r2_d_threshold=0.1&window=500000&p_threshold=0.1`,
                    target: '_blank'
                  },
                  'Find tissue eQTLs'
                )
                ...
                h(
                  ...
                  {
                    className: 'font-weight-bold',
                    href: `${ldLinkUrl}?snps=${record.snp}&pop=${ancestry}&genome_build=grch37&r2_d=r2&r2_d_threshold=0.1&window=500000&ifContinue=Continue`,
                    target: '_blank'
                  },
