...
export function About() {
  return (
    <div className="container my-4">
      ...
      <p>The Prostate, Lung, Colorectal, Ovarian (PLCO) Cancer Screening Study is a large population-based randomized trial designed and sponsored by the National Cancer Institute (NCI) to determine the effects of screening on cancer-related mortality and secondary endpoints in men and women aged 55 to 74. The screening component of the trial was completed in 2006. Existing data from the trial is available and can be obtained from the Cancer Data Access System website (<a href="https://biometry.nci.nih.gov/cdas/plco/">https://biometry.nci.nih.gov/cdas/plco/</a>). Biological samples are also available to the entire scientific community through a peer-review process.</p>
