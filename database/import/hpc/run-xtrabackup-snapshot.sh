...
sbatch --gres=lscratch:200 --mem=512g --cpus-per-task=32 --partition=largemem --time=08:00:00 --wrap="sh xtrabackup-snapshot.sh $DB_USER $DB_PASS $BASE_DIR $TARGET_DIR $BUCKET_NAME $BUCKET_FOLDER"
