...
sbatch --gres=lscratch:200 --mem=200g --cpus-per-task=24 --time=48:00:00 --output=$LOG_PATH/sbatch.out --wrap="sh parallel-import-combined-variant-mysql.sh $INPUT_DIR $BASE_DIR $USER $PASSWORD $LOG_PATH"
