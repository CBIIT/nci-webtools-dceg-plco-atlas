...
sbatch --gres=lscratch:200 --mem=512g --cpus-per-task=72 --partition=largemem --time=48:00:00 --wrap="sh import-local-mysql.sh $DB_USER $DB_PASS $BASE_DIR $DATA_DIR $NUM_JOBS"
