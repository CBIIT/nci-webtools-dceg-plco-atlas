...
sbatch --gres=lscratch:200 --mem=256g --cpus-per-task=72 --partition=norm --time=08:00:00 --wrap="sh import-local-mysql.sh $DB_USER $DB_PASS $ARCHIVE_FILE $COMMANDS_FILE $NUM_JOBS"
