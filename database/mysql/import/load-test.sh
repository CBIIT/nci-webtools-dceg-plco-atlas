...
mysql --host $PLCO_HOST --port $PLCO_PORT  --user $PLCO_USER --password $PLCO_PASSWORD --database $PLCO_DATABASE "DROP TABLE ewings_sarcoma_2_variant; DROP TABLE ewings_sarcoma_2_aggregate;"
sed \
...
mysql --host $PLCO_HOST --port $PLCO_PORT  --user $PLCO_USER --password $PLCO_PASSWORD --database $PLCO_DATABASE "DROP TABLE melanoma_3_variant; DROP TABLE melanoma_3_aggregate;"
sed \
...
mysql --host $PLCO_HOST --port $PLCO_PORT  --user $PLCO_USER --password $PLCO_PASSWORD --database $PLCO_DATABASE "DROP TABLE renal_cell_carcinoma_4_variant; DROP TABLE renal_cell_carcinoma_4_aggregate;"
sed \
