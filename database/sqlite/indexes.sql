...
CREATE INDEX idx_variant_all_plot_qq            ON variant_all(plot_qq);
...
CREATE INDEX idx_variant_female_plot_qq         ON variant_female(plot_qq);
...
CREATE INDEX idx_variant_male_plot_qq           ON variant_male(plot_qq);
