...
CREATE TABLE IF NOT EXISTS ${table_name} (
    ...
    odds_ratio_ci_95_low decimal(64,16) AS (IF(odds_ratio IS NULL, NULL, (CAST(EXP(CAST(beta_ci_95_low as decimal(64,16))) as decimal(64,16))))) STORED NULL,
    odds_ratio_ci_95_high decimal(64,16) AS (IF(odds_ratio IS NULL, NULL, (CAST(EXP(CAST(beta_ci_95_high as decimal(64,16))) as decimal(64,16))))) STORED NULL,
    n int NULL,
