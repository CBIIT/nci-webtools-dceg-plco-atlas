...
node import.js ../data/meta_fixed_assoc.meta ../data/meta_fixed_assoc_new.db ewing all
# node import.js ../data/rcc.txt ../data/meta_fixed_assoc_new.db rcc female
# node import.js ../data/mel.txt ../data/meta_fixed_assoc_new.db mel male
...
# node import.js ../data/mel.txt ../data/mel.db ewing male
